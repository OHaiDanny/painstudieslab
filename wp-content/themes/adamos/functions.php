...
/* ENABLE JQUERY SCRIPT FILE */
//function my_scripts_method() {
//// register your script location, dependencies and version
//   wp_register_script('custom_script',
//   get_template_directory_uri() . '/scripts/painLabsv3.12.js',
//   array('jquery'),
//   '1.0', true);
// // enqueue the script
...
function adamos_scripts() {
	...
	if (!is_admin()) {
        wp_enqueue_script( 'painLabs', get_template_directory_uri() . '/scripts/painLabs.js', array( 'jquery' ), '123232455', true );
        wp_enqueue_script( 'small-menu', get_template_directory_uri() . '/js/small-menu.js', array( 'jquery' ), '20120206', true );
        wp_enqueue_script('js-test', get_template_directory_uri() . '/js/js-test.js', array('jquery'), '20151007', true);
	}
